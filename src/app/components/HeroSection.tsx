...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    if (video) {
      ...
      // Set video to mute and loop for better autoplay compatibility
      video.muted = true;
      video.loop = true;
      ...
      const playVideo = async () => {
        try {
          ...
          console.log(
            "Video autoplay failed, trying with user interaction fallback:",
            error
          );
          // Fallback: if autoplay fails, wait for user interaction
